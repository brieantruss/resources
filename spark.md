...
## Download
https://www.apache.org/dyn/closer.lua/spark/spark-3.5.5/spark-3.5.5-bin-hadoop3.tgz
...
export SPARK_LOCAL_IP=192.168.0.106

spark.master spark://192.168.0.106:7077
spark.driver.host 192.168.0.106
spark.driver.bindAddress 192.168.0.106

export SPARK_MASTER_HOST=192.168.0.106 # on host
export SPARK_MASTER_URL=spark://192.168.0.106:7077 # add the master node on workers
save as spark-env.sh

nano spark-defaults.conf
export SPARK_MASTER_HOST=192.168.0.106 # on host
spark.worker.memory 2g # on workers
spark.worker.cores 1 # on workers


## In spark-defaults.conf on master
spark.master spark://192.168.0.106:7077
spark.driver.host 192.168.0.106
spark.driver.bindAddress 192.168.0.245

## In spark-defaults.conf on workers
spark.master spark://192.168.0.10:7077
...
### Start Worker
cd  /opt/spark/spark-3.5.5-bin-hadoop3/sbin
./start-worker.sh spark://192.168.0.106:7077

#### after moving spark application to location of spark install (/opt/spark/spark-3.5.5-bin-hadoop3/bin/):
/opt/spark/spark-3.5.5-bin-hadoop3/bin/spark-submit --master spark://192.168.0.245:7077 transform_steps.py

# RUNNING A JOB
cd /opt/spark/spark-3.5.5-bin-hadoop3/bin/

./spark-submit --master spark://192.168.0.106:7077 transform_steps.py
