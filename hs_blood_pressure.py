...
with DAG(
    dag_id='health_stats_blood_pressure',
    ...
    RAW_FILES_DIR = "/home/modulo/development/health_stats/raw_files/blood_pressure"
    PROCESSED_FILES_DIR = "/home/modulo/development/health_stats/processed_files/blood_pressure"
    ...
    extract_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/extract_blood_pressure.py "{GCS_KEY_FILE}" "{RAW_FILES_DIR}"',
    ...
    transform_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/transform_blood_pressure.py "{RAW_FILES_DIR}" "{PROCESSED_FILES_DIR}"',
    )
    ...
    load_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/load_blood_pressure.py "{PROCESSED_FILES_DIR}"',
    )
