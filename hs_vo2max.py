...
with DAG(
    ...
    RAW_FILES_DIR = "/home/modulo/development/health_stats/raw_files/vo2max"
    PROCESSED_FILES_DIR = "/home/modulo/development/health_stats/processed_files/vo2max"
    ...
    extract_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/extract_vo2max.py "{GCS_KEY_FILE}" "{RAW_FILES_DIR}"',
    ...
    transform_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/transform_vo2max.py "{RAW_FILES_DIR}" "{PROCESSED_FILES_DIR}"',
    )
    ...
    load_task = BashOperator(
        ...
        bash_command=f'python3 {PIPELINE_SCRIPTS_DIR}/load_vo2max.py "{PROCESSED_FILES_DIR}"',
    )
